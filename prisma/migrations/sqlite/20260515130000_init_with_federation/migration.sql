...
CREATE TABLE "BindingPermission" (
    ...
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "BindingPermission_binding_id_fkey" FOREIGN KEY ("binding_id") REFERENCES "AppBinding" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "RolePermission" (
    ...
    CONSTRAINT "RolePermission_permission_id_fkey" FOREIGN KEY ("permission_id") REFERENCES "BindingPermission" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "UserRole" (
    ...
    "aioson_play_origin_id" TEXT,
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "UserRole_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "GlobalUser" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE "AuthSession" (
    ...
    "aioson_play_id" TEXT,
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "AuthSession_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "GlobalUser" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
